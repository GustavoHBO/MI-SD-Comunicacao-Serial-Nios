add wave -noupdate -divider {processor_nios2_qsys_0: top-level ports}
...
add wave -noupdate -divider {processor_nios2_qsys_0: common}
...
add wave -noupdate -divider {processor_nios2_qsys_0: breaks}
